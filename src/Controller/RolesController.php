...
class RolesController extends AbstractController
{
    ...
    {
        return $this->render('roles/index.html.twig', ['roles' => $rolesRepository->findAll()]);
    }
    ...
    {
        return $this->render('roles/show.html.twig', ['role' => $role]);
    }
    ...
    public function edit(Request $request, Roles $role): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('roles_index', ['id' => $role->getId()]);
        }
